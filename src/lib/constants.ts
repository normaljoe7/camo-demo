...
export const expeditions = [
    {
      ...
      description: 'Journey to the North Pole through frozen landscapes',
      duration: '14 days',
      difficulty: 'Advanced',
      price: '$4,999',
      season: 'June - August',
  ...
  export const galleryImages = [
    { id: 1, src: '/images/gallery/1.jpg', alt: 'Mountain expedition', category: 'mountains' },
    { id: 2, src: '/images/gallery/2.jpg', alt: 'Jungle exploration', category: 'jungle' },
    { id: 3, src: '/images/gallery/3.jpg', alt: 'Desert camping', category: 'desert' },
    { id: 4, src: '/images/gallery/4.jpg', alt: 'Polar adventure', category: 'polar' },
    { id: 5, src: '/images/gallery/5.jpg', alt: 'River expedition', category: 'water' },
    { id: 6, src: '/images/gallery/6.jpg', alt: 'Base camp', category: 'mountains' },
  ];