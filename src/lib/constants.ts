...
export const expeditions = [
  {
    ...
    floraFauna: 'Tigers, leopards, Asian elephants, gaur, dholes, deer species, and over 200 bird species thrive here among teak, sandalwood, bamboo, and riverine forests.',
    ...
    policy: 'Full payment is required at the time of booking to confirm your reservation Advance booking of a minimum of 7 days is mandatory Cancellations are permitted up to 5 days prior to the scheduled safari date, with a 30% refund applicable. Rescheduling or transfer of bookings is strictly not permitted.'
  },
  {
    id: 2,
    ...
    floraFauna: 'Tigers, leopards, Asian elephants, gaur, sloth bears, dholes, chital, sambar deer, wild boar, and rich birdlife thrive across dry deciduous, moist deciduous, thorn, and riverine forests dominated by teak, bamboo, Terminalia, and grassland patches',
  ...
  },
  {
    ...
    floraFauna: 'Wildlife includes Tiger, Leopard, Sloth Bear, Gaur, Sambar, Spotted Deer, Wild Dogs, and over 250 bird species. The reserve supports evergreen and moist deciduous forests with teak, bamboo, sandalwood, and fig trees.',
    safariExperience: `Morning Safari: Early forest hours with high wildlife activity and excellent bird sightings.
Evening Safari: Golden-hour drives featuring grazing herbivores and predator movement.`,
  ...
  },
  {
    ...
    floraFauna: 'Bengal Tigers, Asian Elephants, Leopards, Wild Dogs, Gaur, Sloth Bears, diverse deer species, and rich birdlife including hornbills and raptors. Forests include moist and dry deciduous vegetation with teak and bamboo.',
  ...
  },
  {
    ...
    floraFauna: 'Flora: Sal forests, tall grasslands, wetlands, and riverine vegetation. Fauna: Royal Bengal Tiger, Leopard, Swamp Deer, Chital, Sambar, Hog Deer, Sloth Bear, and over 450 species of birds.',
    ...
    policy: 'Full payment is required at the time of booking to confirm your reservation Advance booking of a minimum of 90 days is mandatory Cancellations are permitted up to 80 days prior to the scheduled safari date, with a 30% refund applicable. Rescheduling or transfer of bookings is strictly not permitted.'
  },
  {
    id: 6,
    ...
    floraFauna: 'Sal forests, bamboo groves, grasslands, and mixed deciduous vegetation support tigers, leopards, sloth bears, deer species, primates, and over 250 species of birds.',
  ...
  },
  {
    ...
    floraFauna: 'Flora: Teak, Bamboo, Mixed Deciduous Forests Fauna: Tiger, Leopard, Wild Dog, Sloth Bear, Spotted Deer, Sambar, 300+ Bird Species',
  ...
  },
  {
    ...
    floraFauna: 'Dominated by dry deciduous forests featuring teak, salai, mahua, bamboo, and tendu trees. The reserve is home to Bengal tigers, leopards, sloth bears, chital, sambar, nilgai, chinkara, crocodiles, gharials, and more than 200 species of bird',
  ...
  },
  {
    ...
    floraFauna: 'Royal Bengal Tiger, Leopard, Sloth Bear, Wild Dog, Gaur, Sambar, Chital, Crocodiles, and rich birdlife. Vegetation includes teak, bamboo, grasslands, and seasonal wetlands.',
...
export const galleryImages = [
  {
    id: 1,
    src: '/images/bandipur.png',
    alt: 'Bandipur Tiger Reserve',
    category: 'Wildlife',
    date: 'March 15, 2024',
    time: '6:45 AM',
    camera: 'Canon EOS R5',
    lens: 'RF 100-500mm',
    settings: 'f/5.6 | 1/1250s | ISO 800'
  },
  {
    id: 2,
    src: '/images/mudumalai.png',
    alt: 'Mudumalai Tiger Reserve',
    category: 'Jungle',
    date: 'February 10, 2024',
    time: '5:30 PM',
    camera: 'Sony A1',
    lens: 'FE 600mm GM',
    settings: 'f/4 | 1/1000s | ISO 1600'
  },
  {
    id: 3,
    src: '/images/bhadra.png',
    alt: 'Bhadra Tiger Reserve',
    category: 'Mountain',
    date: 'January 22, 2024',
    time: '7:15 AM',
    camera: 'Nikon Z9',
    lens: 'Nikkor 400mm f/2.8',
    settings: 'f/2.8 | 1/2000s | ISO 400'
  },
  {
    id: 4,
    src: '/images/nagarhole.png',
    alt: 'Nagarhole Tiger Reserve',
    category: 'River',
    date: 'April 5, 2024',
    time: '4:45 PM',
    camera: 'Canon EOS R3',
  ...
  {
    id: 5,
    src: '/images/bandipur1.png',
    alt: 'Bandipur Peacock',
    category: 'Wildlife',
    date: 'March 16, 2024',
    time: '8:30 AM',
    camera: 'Fujifilm X-T5',
    lens: 'XF 150-600mm',
    settings: 'f/8 | 1/500s | ISO 320'
  },
  {
    id: 6,
    src: '/images/mudumalai1.png',
    alt: 'Mudumalai Leopard',
    category: 'Wildlife',
    date: 'February 11, 2024',
    time: '6:15 PM',
    camera: 'Sony A7RV',
    lens: 'FE 200-600mm',
    settings: 'f/6.3 | 1/800s | ISO 2500'
  },
  {
    id: 7,
    src: '/images/nagarhole1.png',
    alt: 'Nagarhole Panther',
    category: 'Wildlife',
    date: 'April 6, 2024',
    time: '5:50 AM',
    camera: 'Canon EOS R5',
    lens: 'RF 100-500mm',
    settings: 'f/7.1 | 1/640s | ISO 12800'
  },
  {
    id: 8,
    src: '/images/pilibhit.png',
    alt: 'Pilibhit Tiger',
    category: 'Wildlife',
    ...
    settings: 'f/6.3 | 1/1250s | ISO 500'
  },
  {
    id: 9,
    src: '/images/bandhavgarh.png',
    alt: 'Bandhavgarh Deer',
    category: 'Wildlife',
    date: 'November 20, 2023',
    time: '3:30 PM',
    camera: 'Canon EOS R6 Mark II',
    lens: 'RF 70-200mm f/2.8',
    settings: 'f/2.8 | 1/2000s | ISO 200'
  },
  {
    id: 10,
    src: '/images/pench.png',
    alt: 'Pench Leopard',
    category: 'Wildlife',
    date: 'January 5, 2024',
    time: '6:30 PM',
    camera: 'Sony A9 III',
    lens: 'FE 300mm f/2.8',
    settings: 'f/2.8 | 1/400s | ISO 6400'
  },
  {
    id: 11,
    src: '/images/panna.png',
    alt: 'Panna Bear',
    category: 'Wildlife',
    date: 'February 28, 2024',
    time: '7:45 AM',
    camera: 'OM System OM-1',
    lens: 'M.Zuiko 150-400mm',
    settings: 'f/4.5 | 1/1000s | ISO 1600'
  },
  {
    id: 12,
    src: '/images/tadoba.png',
    alt: 'Tadoba Tiger',
    category: 'Wildlife',
    date: 'March 30, 2024',
    time: '4:15 PM',
    camera: 'Nikon D850',
    lens: 'Nikkor 500mm f/4',
    settings: 'f/4 | 1/2500s | ISO 400'
  },
];